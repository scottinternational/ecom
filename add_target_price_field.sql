-- =====================================================
-- ADD TARGET PRICE FIELD TO PRODUCT SUGGESTIONS
-- =====================================================
-- This script adds a target_price column to store the target selling price
-- for the product suggestion

-- Add target_price column to store target selling price
...
SELECT 'Target price column added successfully!' as status;
